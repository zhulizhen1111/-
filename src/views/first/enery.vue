<template>
  <div class="enery">
    ...
    <div class="my-div">
      <div class="my-card">
        <p class="p1">今日能耗</p>
        <p class="p2">{{getAnnualEnergy.averageTodayEnergy || '--'}}</p>
      </div>
      <div class="my-card">
        <p class="p1">昨日能耗</p>
        <p class="p2">{{getAnnualEnergy.averageLastDayEnergy || '--'}}</p>
      </div>
    </div>
    <p class="ec-title">
      能耗变化曲线
...
export default {
  ...
  methods: {
    formatData() {
        console.log(this.getAnnualEnergy)
      let today = this.getAnnualEnergy.data.today;
      let yesterday = this.getAnnualEnergy.data.lastDay;
      this.todayData = [];
      this.yesterdayData = [];
      this.todayData = Object.values(today);
      this.yesterdayData = Object.values(yesterday);
      this.drawEnery();
    },
    drawEnery() {
